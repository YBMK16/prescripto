    ...
    docInfo && (
      <div>
        ...
        <div className='flex flex-col sm:flex-row gap-4'>
          <div>
            <img
              className='bg-primary w-full sm:max-w-72
            rounded-lg'
              src={docInfo?.image}
              alt=''
            />
          ...
          <div
            className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px]
          sm:mt-0'
          >
            {/* ------ name, deg, exp ------ */}
            ...
            <div>
              ...
              font-medium text-gray-900 mt-3'
              >
